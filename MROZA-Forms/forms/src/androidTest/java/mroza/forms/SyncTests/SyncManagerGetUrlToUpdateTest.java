...
public class SyncManagerGetUrlToUpdateTest extends ActivityInstrumentationTestCase2<ChooseKidActivity> {


    private SyncManager syncManager;
    private String expectedUrl = "http://10.0.2.2:8080/ws/rest/syncData";

    public SyncManagerGetUrlToUpdateTest() {
    ...
    protected void setUp() throws Exception {
        ...
        editor.putString("URL_TO_SEND_UPDATE", expectedUrl);
        editor.commit();
    }
